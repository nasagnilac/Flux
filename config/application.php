...
return array(
	'ServerAddress'        => 'prestige.ragnarok.world',              // This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'              => '',                       // The base URI is the base web root on which your application lies.
	'InstallerPassword'    => 'fp4SJN8hxV',         // Installer/updater password.
	...
	'SiteTitle'            => 'Prestige Control Panel',     // This value is only used if the theme decides to use it.
	...
	'CreditExchangeRate'   => 0.0015,                      // The rate at which currency is exchanged for credits.
	'MinDonationAmount'    => 15,                      // Minimum donation amount. (NOTE: Actual donations made that are less than this account won't be exchanged)
	...
	'ItemShopMaxCost'      => 50000,                       // Max price an item can be sold for.
	'ItemShopMaxQuantity'  => 30000,                       // Max quantity the item may be sold at once for.
	'ItemShopItemPerPage'  => 6,                        // The number of items to display per page in the "Item Shop" page.
	...
	'CharRankingLimit'       => 10,                     //
	'GuildRankingLimit'      => 10,                     //
	'ZenyRankingLimit'       => 10,                     //
	'DeathRankingLimit'      => 10,                     //
	'AlchemistRankingLimit'  => 10,                     //
	'BlacksmithRankingLimit' => 10,                     //
