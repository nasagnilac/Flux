...
class Flux_ItemShop {
	...
	public function getItems($paginator, $categoryID = null)
	{
		...
		$col  .= "$shop.nameid AS shop_item_nameid, $shop.info AS shop_item_info, items.name_japanese AS shop_item_name";
		$col .= ", items.type AS shop_item_type, items.slots AS shop_item_slot, items.equip_locations AS shop_equip_location,"; 
		$col .= " items.defence AS shop_item_defence, items.weight AS shop_item_weight, items.equip_jobs AS shop_item_equipjobs ";
		if (!is_null($categoryID)) {
